...
const LoggerFactory = require('@codefresh-io/cf-common').LoggerFactory;
...
console.log(`Starting with loggger configuration : ${JSON.stringify(loggerConfig)}`);
const loggerImpl = LoggerFactory.getLogger(loggerConfig);
